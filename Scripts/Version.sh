...
# v1.1.1 25-Jul-16 Minor change to allow to run within Script/ subdir. (Michelangelo De Simone)


version() {
	echo "version.sh by Joachim Bondo <osteslag@gmail.com> http://osteslag.tumblr.com"
	echo "version.sh 1.1.1 by Michelangelo De Simone <michel@ngelo.eu>"
}
